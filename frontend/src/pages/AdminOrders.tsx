...
import { ShoppingCart, LogOut, ChevronDown, ChevronUp, Package, Mail, MapPin, Calendar } from 'lucide-react'
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-right">
                              <p className="font-bold text-lg text-[#e94560]">${order.total.toFixed(2)}</p>
                        ...
                        >
                          <div className="border-t border-gray-100 px-5 py-4 space-y-4">
                            ...
                            <div className="flex items-start gap-2 text-sm">
                              ...
                              <div>
                                <p className="font-medium text-[#1a1a2e] text-xs uppercase tracking-wider text-gray-500 mb-0.5">Shipping Address</p>
                                ...
                                <table className="w-full text-sm">
                                  ...
                                  <tbody>
                                    {items.map((item, i) => (
                                      <tr key={i} className="border-t border-gray-50">
                                        ...
                                        <td className="px-3 py-2.5 text-right text-gray-500">${item.price.toFixed(2)}</td>
                                        <td className="px-3 py-2.5 text-right font-semibold">${(item.price * item.quantity).toFixed(2)}</td>
                                      </tr>
                                    ))}
                                  </tbody>
                                  <tfoot className="bg-gray-50 border-t border-gray-100">
                                    <tr>
                                      ...
                                      <td className="px-3 py-2.5 text-right font-bold text-[#e94560]">${order.total.toFixed(2)}</td>
                                    </tr>
                                  </tfoot>
                                </table>
                              </div>
